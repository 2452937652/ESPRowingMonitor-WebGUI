...
This repository's personal six-magnet build is published at [EdgeOne](https://esp-rowing-monitor-webgui.edgeone.dev/). It is based on upstream v7.2.0 and adds the optional physical Force Curve V2 transport, stroke-keyed sessions, and Chinese interface support. See [the Chinese deployment and rollback notes](README.zh-CN.md) for this hardware build.
...
The official upstream PWA is hosted on [GitHub Pages](https://abasz.github.io/ESPRowingMonitor-WebGUI); this personal six-magnet build is hosted on [EdgeOne](https://esp-rowing-monitor-webgui.edgeone.dev/). HTTPS provides the secure context required by browser APIs such as Web Bluetooth and WebUSB.
